...
print("So Kevin is going to pay $%d." %((ceil(bill/100))*100)   # replace with your code
print("The cafe is giving %f to Kevin." %((ceil(bill/100)*100)-bill)   # replace with your code
print("Each one should give %f to Kevin." %((ceil(bill/100)*100)/people) # replace with your code
