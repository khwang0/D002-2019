...
print("So Kevin is going to paid $%d." % (bill/people))   # replace with your code
print("The cafe is giving %f to Kevin." % (100-bill/people))  # replace with your code
print("Each one should give %f to Kevin." % ((100-bill/people)/people)) # replace with your code
...
count = 1
i=0
while i<100: # replace with your code
    if number!=6:
