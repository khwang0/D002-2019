...
kpay = ceil(bill / 100) * 100
change = kpay - bill
pay = bill / people
print("Kevin paid the bill first. But Kevin only has 100 dollar notes")
print("So Kevin is going to paid $%d." % kpay)   # replace with your code
print("The cafe is giving %f to Kevin." % change)  # replace with your code
print("Each one should give %f to Kevin." % pay) # replace with your code
